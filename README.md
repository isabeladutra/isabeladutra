...
[![My Skills](https://skillicons.dev/icons?i=java,c++,nodejs,aws,gcp,azure,html,js,css,ts,angular,mysql,postgres,vscode,git,discord,github,linux,windows,springboot&perline=10)](https://skillicons.dev)
